 ...
 */
// public abstract class AbstractTxTask<TX extends TransactionExtend, CHANMGR extends
// AbstractChanMgr, CHAN extends AbstractChannel> implements Callable<List<TX>>
// {
public abstract class AbstractTxTask<TX extends TransactionExtend, P2P extends IP2pMgr>

...
public final class BroadcastTx extends Msg {
    ...
    private final List<? extends TransactionExtend> txl;

    public BroadcastTx(final List<? extends TransactionExtend> _txl) {
    ...
    /* return the encodedData of the TransactionExtend list, the caller function need to cast the return byte[] array
     */

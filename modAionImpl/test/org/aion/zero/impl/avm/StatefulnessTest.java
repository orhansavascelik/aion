...
public class StatefulnessTest {
    ...
    public void testStateOfActorsAfterDeployment() {
        BigInteger deployerBalance = this.blockchain.getRepository().getBalance(this.deployer);
        BigInteger deployerNonce = this.blockchain.getRepository().getNonce(this.deployer);
        ...
        BigInteger deployerBalanceAfterDeployment = this.blockchain.getRepository().getBalance(this.deployer);
        BigInteger deployerNonceAfterDeployment = this.blockchain.getRepository().getNonce(this.deployer);
        BigInteger contractBalance = this.blockchain.getRepository().getBalance(contract);

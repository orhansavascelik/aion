...
public final class FastSyncManagerTest {
    ...
    @Test
    public void testIsCompleteContractStorage_withIncompleteReceipts() {
        AionBlockchainImpl chain = mock(AionBlockchainImpl.class);
        ...
        assertThat(manager.isCompleteContractStorage()).isFalse();
    }

    @Test
    public void testIsCompleteContractStorage_withIncompleteWorldState() {
        AionBlockchainImpl chain = mock(AionBlockchainImpl.class);
    ...
    @Test
    public void testIsCompleteContractStorage_withExistingNodes() {
        AionBlockchainImpl chain = mock(AionBlockchainImpl.class);
    ...
    @Test
    public void testIsCompleteContractStorage_withPostPivotInceptionBlock() {
        ...
        assertThat(manager.isCompleteContractStorage()).isTrue();
    }

    @Test(expected = IllegalStateException.class)
    public void testIsCompleteContractStorage_withIllegalState() {
        long pivotBlockNumber = 10;
        Address contract = AionAddress.wrap(nodeKey);
    ...
    @Test
    public void testIsCompleteContractStorage_withCompleteContracts() {
    ...
    @Test
    public void testIsCompleteContractStorage_withIncompleteContractAndPostPivotInceptionBlock() {
        long pivotBlockNumber = 10;
        Address contract1 = AionAddress.wrap(nodeKey);
        Address contract2 = AionAddress.wrap(altNodeKey);
    ...
    @Test
    public void testIsCompleteContractStorage_withIncompleteContracts() {
        Address contract1 = AionAddress.wrap(nodeKey);
        Address contract2 = AionAddress.wrap(altNodeKey);
    ...
    @Test
    public void testIsCompleteContractStorage_withIncompleteContractsAndLimit() {
        Address contract1 = AionAddress.wrap(nodeKey);
        Address contract2 = AionAddress.wrap(altNodeKey);

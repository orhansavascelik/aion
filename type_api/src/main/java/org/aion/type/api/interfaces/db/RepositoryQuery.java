...
public interface RepositoryQuery<AS> {
     ...
     */
    Map<Wrapper, Wrapper> getStorage(
     ...
     * @return a {@link Wrapper} representing the data associated with the given key
     */
    Wrapper getStorageValue(Address address, Wrapper key);

...
public interface ContractDetails {
     ...
     */
    void put(Wrapper key, Wrapper value);
     ...
     */
    Map<Wrapper, Wrapper> getStorage(Collection<Wrapper> keys);
     ...
     */
    void setStorage(Map<Wrapper, Wrapper> storage);

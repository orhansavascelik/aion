...
public class Hash256Test {
    ...
    private final Wrapper[] hashArray = { // Same as hashHex
        null,
    ...
    public void testWrap() {
        ...
        for (int a = 0; a < hashArray.length; a++) {
            try {
                tempArray = Hash256.wrap((ByteArrayWrapper) hashArray[a]);
    ...
    public void testCompare() {
        ...
        for (int b = 3; b < 6; b++) {
            try {
                int temp = Hash256.wrap((ByteArrayWrapper) hashArray[b]).compareTo(Hash256.wrap((ByteArrayWrapper)hashArray[b + 1]));
                boolean same = Hash256.wrap((ByteArrayWrapper)hashArray[b]).equals(Hash256.wrap((ByteArrayWrapper)hashArray[b + 1]));
                boolean negative = temp < 0;
                System.out.println("Test " + b + " & " + (b + 1) + " >> " + temp);
                assertFalse(same);
                assertTrue(negative);

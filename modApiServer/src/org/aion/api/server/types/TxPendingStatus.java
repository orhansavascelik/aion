...
public class TxPendingStatus {
    ...
    private ByteArrayWrapper txhash;
    private ByteArrayWrapper socketId;
    ...
    public TxPendingStatus(
            ByteArrayWrapper txHash, ByteArrayWrapper id, ByteArrayWrapper msgHash, int v, ByteArrayWrapper txRes, String error) {
